...
var G__36284 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__36284) : datascript.lru.cleanup_lru.call(null,G__36284));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__36292 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36292,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36292,(1),null);
...
var datascript$lru$ICache$_get$dyn_36330 = (function (this$,key,compute_fn){
...
return datascript$lru$ICache$_get$dyn_36330(this$,key,compute_fn);
}
});

datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
if((typeof datascript !== 'undefined') && (typeof datascript.lru !== 'undefined') && (typeof datascript.lru.t_datascript$lru36321 !== 'undefined')){
} else {
...
*/
datascript.lru.t_datascript$lru36321 = (function (limit,_STAR_impl,meta36322){
this.limit = limit;
...
(datascript.lru.t_datascript$lru36321.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36323,meta36322__$1){
var self__ = this;
var _36323__$1 = this;
return (new datascript.lru.t_datascript$lru36321(self__.limit,self__._STAR_impl,meta36322__$1));
}));

(datascript.lru.t_datascript$lru36321.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36323){
var self__ = this;
var _36323__$1 = this;
return self__.meta36322;
}));

(datascript.lru.t_datascript$lru36321.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru36321.prototype.datascript$lru$ICache$_get$arity$3 = (function (this$,key,compute_fn){
var self__ = this;
var this$__$1 = this;
...
(datascript.lru.t_datascript$lru36321.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta36322","meta36322",-1265685795,null)], null);
}));

(datascript.lru.t_datascript$lru36321.cljs$lang$type = true);

(datascript.lru.t_datascript$lru36321.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru36321");

(datascript.lru.t_datascript$lru36321.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"datascript.lru/t_datascript$lru36321");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru36321.
 */
datascript.lru.__GT_t_datascript$lru36321 = (function datascript$lru$cache_$___GT_t_datascript$lru36321(limit__$1,_STAR_impl__$1,meta36322){
return (new datascript.lru.t_datascript$lru36321(limit__$1,_STAR_impl__$1,meta36322));
});

}

return (new datascript.lru.t_datascript$lru36321(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
