...
var len__5769__auto___42899 = arguments.length;
var i__5770__auto___42900 = (0);
while(true){
if((i__5770__auto___42900 < len__5769__auto___42899)){
args__5775__auto__.push((arguments[i__5770__auto___42900]));

var G__42901 = (i__5770__auto___42900 + (1));
i__5770__auto___42900 = G__42901;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42821){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42822,G__42823,seq42821__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42850_SHARP_){
return (!((cljs.core.meta(p1__42850_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42865__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42867){var _e__26784__auto__ = e42867;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e42875){var _e__26784__auto__ = e42875;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42885 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42886 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42886);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42887__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42885);
}});
...
var temp__5802__auto___42912 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___42912)){
var managed_print_level_42913 = temp__5802__auto___42912;
var _STAR_print_level_STAR__orig_val__42894_42914 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42895_42915 = managed_print_level_42913;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42895_42915);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42893_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42893_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42894_42914);
}} else {
job_fn();
}
