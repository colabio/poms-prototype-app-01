...
var self__ = this;
var self__ = this;
var G__47335 = (arguments.length - (1));
switch (G__47335) {
case (1):
...
(missionary.impl.Dataflow.Port.prototype.apply = (function (self__,args47331){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args47331)));
}));
...
var _BANG_ = (function (p1__47329_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__47329_SHARP_) : s_BANG_.call(null,p1__47329_SHARP_));
});
...
var G__47352 = (new missionary.Cancelled("Dataflow variable dereference cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__47352) : f_BANG_.call(null,G__47352));
} else {
return null;
}
}
