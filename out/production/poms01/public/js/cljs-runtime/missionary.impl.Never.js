...
var self__ = this;
var self__ = this;
var G__47532 = (arguments.length - (1));
switch (G__47532) {
case (0):
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args47529){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args47529)));
}));
...
var G__47572 = (new missionary.Cancelled("Never cancelled."));
var fexpr__47571 = ps.f;
return (fexpr__47571.cljs$core$IFn$_invoke$arity$1 ? fexpr__47571.cljs$core$IFn$_invoke$arity$1(G__47572) : fexpr__47571.call(null,G__47572));
} else {
return null;
}
});
