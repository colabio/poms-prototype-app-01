...
var self__ = this;
var self__ = this;
var G__47431 = (arguments.length - (1));
switch (G__47431) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args47430){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args47430)));
}));
...
var vec__47451 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47451,(0),null);
...
var G__47462 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__47462) : f_BANG_.call(null,G__47462));
} else {
return null;
}
});
