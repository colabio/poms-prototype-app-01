...
var self__ = this;
var self__ = this;
var G__47175 = (arguments.length - (1));
switch (G__47175) {
case (0):
...
(missionary.impl.Watch.Process.prototype.apply = (function (self__,args47167){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args47167)));
}));
...
if((ps.notifier == null)){
var fexpr__47222_47247 = ps.terminator;
(fexpr__47222_47247.cljs$core$IFn$_invoke$arity$0 ? fexpr__47222_47247.cljs$core$IFn$_invoke$arity$0() : fexpr__47222_47247.call(null));
