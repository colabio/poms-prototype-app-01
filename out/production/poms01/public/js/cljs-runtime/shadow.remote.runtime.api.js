...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34203 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34203(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_34221 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_34221(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_34232 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_34232(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_34239 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_34239(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34245 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34245(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34248 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34248(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__34182,callback){
var map__34184 = p__34182;
var map__34184__$1 = cljs.core.__destructure_map(map__34184);
var input = map__34184__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34184__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34184__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
