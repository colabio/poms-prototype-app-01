...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__46604){
var map__46605 = p__46604;
var map__46605__$1 = cljs.core.__destructure_map(map__46605);
var ast = map__46605__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46605__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
return cljs.core.boolean$((function (){var and__5043__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_(ast);
if(and__5043__auto__){
var G__46610 = (function (){var or__5045__auto__ = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(ast);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
if(cljs.core.truth_((function (){var fexpr__46613 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"var","var",-769682797),null,new cljs.core.Keyword(null,"local","local",-1497766724),null], null), null);
return (fexpr__46613.cljs$core$IFn$_invoke$arity$1 ? fexpr__46613.cljs$core$IFn$_invoke$arity$1(op) : fexpr__46613.call(null,op));
})())){
...
var fexpr__46609 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"seq","seq",-177272256,null),"null",new cljs.core.Symbol(null,"boolean","boolean",-278886877,null),"null"], null), null);
return (fexpr__46609.cljs$core$IFn$_invoke$arity$1 ? fexpr__46609.cljs$core$IFn$_invoke$arity$1(G__46610) : fexpr__46609.call(null,G__46610));
} else {
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__46672_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__46672_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__46682 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__46682,local);
} else {
return G__46682;
}
});
...
var map__46690 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__46690__$1 = cljs.core.__destructure_map(map__46690);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46690__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46690__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var map__46694 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__46694__$1 = cljs.core.__destructure_map(map__46694);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46694__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46694__$1,new cljs.core.Keyword(null,"name","name",1843675177));
