...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43052 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43052(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43053 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43053(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43058 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43058(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43059 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43059(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43060 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43060(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43061 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43061(reader);
}
});
...
var G__43101 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43102 = s.append(c);
c = G__43101;
s = G__43102;
continue;
}
