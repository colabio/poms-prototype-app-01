...
var self__ = this;
var self__ = this;
var G__47605 = (arguments.length - (1));
switch (G__47605) {
case (0):
...
(missionary.impl.Eduction.Process.prototype.apply = (function (self__,args47601){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args47601)));
}));
...
var fexpr__47636 = t.terminator;
return (fexpr__47636.cljs$core$IFn$_invoke$arity$0 ? fexpr__47636.cljs$core$IFn$_invoke$arity$0() : fexpr__47636.call(null));
} else {
...
}catch (e47637){var e_47754 = e47637;
(t.error = t.length);

missionary.impl.Eduction.feed.cljs$core$IFn$_invoke$arity$2(t,e_47754);
}
(t.reducer = null);
...
var fexpr__47640_47755 = t.notifier;
(fexpr__47640_47755.cljs$core$IFn$_invoke$arity$0 ? fexpr__47640_47755.cljs$core$IFn$_invoke$arity$0() : fexpr__47640_47755.call(null));
...
}catch (e47642){var __47758 = e47642;
}
if(cljs.core.truth_((t.busy = cljs.core.not(t.busy)))){
continue;
} else {
...
try{if(cljs.core.reduced_QMARK_((function (){var G__47655 = t;
var G__47656 = cljs.core.deref(t.iterator);
return (rf.cljs$core$IFn$_invoke$arity$2 ? rf.cljs$core$IFn$_invoke$arity$2(G__47655,G__47656) : rf.call(null,G__47655,G__47656));
})())){
...
}catch (e47654){var e_47759 = e47654;
(t.error = t.length);

missionary.impl.Eduction.feed.cljs$core$IFn$_invoke$arity$2(t,e_47759);
...
if((t.length > (0))){
var fexpr__47657 = t.notifier;
return (fexpr__47657.cljs$core$IFn$_invoke$arity$0 ? fexpr__47657.cljs$core$IFn$_invoke$arity$0() : fexpr__47657.call(null));
} else {
if(cljs.core.truth_((t.busy = cljs.core.not(t.busy)))){
continue;
} else {
...
var fexpr__47669_47760 = t.notifier;
(fexpr__47669_47760.cljs$core$IFn$_invoke$arity$0 ? fexpr__47669_47760.cljs$core$IFn$_invoke$arity$0() : fexpr__47669_47760.call(null));
}
...
(t__$1.iterator = (function (){var G__47674 = n__$1;
var G__47675 = (function (){
(t__$1.done = true);

return n__$1();
});
return (flow.cljs$core$IFn$_invoke$arity$2 ? flow.cljs$core$IFn$_invoke$arity$2(G__47674,G__47675) : flow.call(null,G__47674,G__47675));
})());
