...
var self__ = this;
var self__ = this;
var G__47408 = (arguments.length - (1));
switch (G__47408) {
case (1):
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args47406){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args47406)));
}));
...
var vec__47416 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47416,(0),null);
...
var _BANG_ = (function (p1__47402_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__47402_SHARP_) : s_BANG_.call(null,p1__47402_SHARP_));
});
...
var G__47432 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__47432) : f_BANG_.call(null,G__47432));
} else {
return null;
}
});
...
var G__47436_47508 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__47436_47508) : s_BANG_.call(null,G__47436_47508));

return missionary.impl.Mailbox.nop;
}
} else {
var G__47441_47509 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__47441_47509) : s_BANG_.call(null,G__47441_47509));
