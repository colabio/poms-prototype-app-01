...
var self__ = this;
var self__ = this;
var G__47489 = (arguments.length - (1));
switch (G__47489) {
case (0):
...
(missionary.impl.RaceJoin.Process.prototype.apply = (function (self__,args47488){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args47488)));
}));
...
var fexpr__47507_47559 = (j.children[i]);
(fexpr__47507_47559.cljs$core$IFn$_invoke$arity$0 ? fexpr__47507_47559.cljs$core$IFn$_invoke$arity$0() : fexpr__47507_47559.call(null));
...
var w = j.race;
if((w < (0))){
try{var G__47517 = j.combinator.apply(null,j.result);
var fexpr__47516 = j.joincb;
return (fexpr__47516.cljs$core$IFn$_invoke$arity$1 ? fexpr__47516.cljs$core$IFn$_invoke$arity$1(G__47517) : fexpr__47516.call(null,G__47517));
}catch (e47513){var e = e47513;
var fexpr__47514 = j.racecb;
return (fexpr__47514.cljs$core$IFn$_invoke$arity$1 ? fexpr__47514.cljs$core$IFn$_invoke$arity$1(e) : fexpr__47514.call(null,e));
}} else {
var G__47520 = (j.result[w]);
var fexpr__47519 = j.racecb;
return (fexpr__47519.cljs$core$IFn$_invoke$arity$1 ? fexpr__47519.cljs$core$IFn$_invoke$arity$1(G__47520) : fexpr__47519.call(null,G__47520));
}
} else {
return null;
}
...
var index_47567 = (0);
while(true){
var join_47568 = ((function (index_47567,n,i,j){
return (function (x){
(j.result[index_47567] = x);

return missionary.impl.RaceJoin.terminated(j);
});})(index_47567,n,i,j))
;
var race_47569 = ((function (index_47567,join_47568,n,i,j){
return (function (x){
var w_47570 = j.race;
if((w_47570 < (0))){
(j.race = index_47567);
...
return join_47568(x);
});})(index_47567,join_47568,n,i,j))
;
(j.children[index_47567] = (function (){var G__47541 = (cljs.core.truth_(r)?race_47569:join_47568);
var G__47542 = (cljs.core.truth_(r)?join_47568:race_47569);
var fexpr__47540 = i.next();
return (fexpr__47540.cljs$core$IFn$_invoke$arity$2 ? fexpr__47540.cljs$core$IFn$_invoke$arity$2(G__47541,G__47542) : fexpr__47540.call(null,G__47541,G__47542));
})());

if(cljs.core.truth_(i.hasNext())){
var G__47573 = (index_47567 + (1));
index_47567 = G__47573;
continue;
} else {
}
break;
