...
var self__ = this;
var self__ = this;
var G__47312 = (arguments.length - (1));
switch (G__47312) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args47310){
var self__ = this;
var self____$1 = this;
...
var G__47321 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__47321) : f_BANG_.call(null,G__47321));
} else {
return null;
}
});
} else {
var vec__47326 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47326,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__47307_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__47307_SHARP_) : s_BANG_.call(null,p1__47307_SHARP_));
});
...
var G__47337 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__47337) : f_BANG_.call(null,G__47337));
} else {
return null;
}
});
} else {
var vec__47339 = temp__5806__auto__;
var vec__47342 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47339,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47342,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47342,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
