...
var self__ = this;
var self__ = this;
var G__47544 = (arguments.length - (1));
switch (G__47544) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args47518){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args47518)));
}));
...
var G__47566 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__47565 = s.failure;
